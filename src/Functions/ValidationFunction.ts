...
const setInitialStyle = () => {
    ...
    (<any>document.getElementById('empId')!).style = ele.EMP_ID;

    ele.EABOUT_ERROR.innerHTML = "";
    (<any>document.getElementById("empAbout")).style = ele.EMP_ABOUT;

    ele.EPROFILE_ERROR.innerHTML = "";
    (<any>document.getElementById("empProfile")).style = ele.EMP_PROFILE;

    ele.EFNAME_ERROR.innerHTML = "";
    (<any>document.getElementById("empFname")).style = ele.EMP_FIRST_NAME;

    ele.EMNAME_ERROR.innerHTML = "";
    (<any>document.getElementById("empMname")).style = ele.EMP_MIDDLE_NAME;

    ele.ELNAME_ERROR.innerHTML = "";
    (<any>document.getElementById("empLname")).style = ele.EMP_LAST_NAME;

    ele.EEMAIl_ERROR.innerHTML = "";
    (<any>document.getElementById("empEmail")).style = ele.EMP_EMAIL;

    ele.EDESIGNATION_ERROR.innerHTML = "";
    (<any>document.getElementById("empDesignation")).style = ele.EMP_DESIGNATION;

    ele.ESKILLS_ERROR.innerHTML = "";
    (<any>document.getElementById("empSkills")).style = ele.EMP_SKILLS;

    ele.EAGE_ERROR.innerHTML = "";
    ele.EEXPERIENCE_ERROR.innerHTML = "";

    ele.ESALARY_ERROR.innerHTML = "";
    (<any>document.getElementById("empSalary")).style = ele.EMP_SALARY;
}

const valid = (eObj: any): boolean => {
    setInitialStyle();
